...
async def attach_media_to_deal(deal_id: int, files: List[Dict]) -> List[int]:
    ...
    try:
        ...
        if not await check_files_attached():
            logger.warning(f"\u26a0\ufe0f \u041f\u043e\u0441\u043b\u0435 \u043f\u0435\u0440\u0432\u043e\u0439 \u043f\u043e\u043f\u044b\u0442\u043a\u0438 \u0444\u0430\u0439\u043b\u044b \u043d\u0435 \u043f\u0440\u0438\u043a\u0440\u0435\u043f\u0438\u043b\u0438\u0441\u044c, \u043f\u0440\u043e\u0431\u0443\u0435\u043c \u0435\u0449\u0451 \u0440\u0430\u0437...")
            await asyncio.sleep(3)
            await call_bitrix_method("crm.deal.update", payload)
            await asyncio.sleep(2)
            if await check_files_attached():
                logger.success(f"\u2705 \u041f\u043e\u0441\u043b\u0435 \u043f\u043e\u0432\u0442\u043e\u0440\u0430 \u0444\u0430\u0439\u043b\u044b \u0443\u0441\u043f\u0435\u0448\u043d\u043e \u043f\u0440\u0438\u043a\u0440\u0435\u043f\u0438\u043b\u0438\u0441\u044c \u043a \u0441\u0434\u0435\u043b\u043a\u0435 {deal_id}")
            else:
                logger.error(f"\u274c \u041f\u043e\u0441\u043b\u0435 \u043f\u043e\u0432\u0442\u043e\u0440\u0430 \u0444\u0430\u0439\u043b\u044b \u0432\u0441\u0451 \u0435\u0449\u0451 \u043d\u0435 \u043f\u0440\u0438\u043a\u0440\u0435\u043f\u043b\u0451\u043d\u044b \u043a \u0441\u0434\u0435\u043b\u043a\u0435 {deal_id}")
    except Exception as e:
